...
public class SVMTrain {
	...
	private static Logger logger = LoggerFactory.getLogger(SVMTrain.class);
	...
	private void do_cross_validation()
	{
		   ...
		   param.svm_type == svm_parameter.NU_SVR)
		{
			...
			logger.error("Cross Validation Mean squared error = "+total_error/prob.l);
			logger.error("Cross Validation Squared correlation coefficient = "+
		...
		else
		{
			for(i=0;i<prob.l;i++)
				if(target[i] == prob.y[i])
					++total_correct;
			logger.error("Cross Validation Accuracy = "+100.0*total_correct/prob.l+"%");
		}
	}
